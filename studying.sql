...
/* usando Union*/
    ...
    SELECT * FROM v.id_video, v.nome_video FROM videos AS v LEFT OUTER JOIN videos_canais AS vc ON v.id_video = vc.fk_video /* A UNION precisa que as colunas das tabelas unidas sejam de quantidade iguais e serve para unir 2 consultas diferentes*/
    UNION
